...
gettext.bindtextdomain("SwapManager", "%s%s" % (resolveFilename(SCOPE_PLUGINS), "SystemPlugins/SwapManager/locale/"))
...
def StartSetup(menuid, **kwargs):
	if menuid == "system":
		return [(_("Swap Manager"), OpenSetup, "swapfile_setup", None)]
	else:
		return []
...
def Plugins(**kwargs):
	return [PluginDescriptor(name = _("Swap Manager"), description = _("Manage your swapfile"), where = PluginDescriptor.WHERE_MENU, fnc = StartSetup), \
